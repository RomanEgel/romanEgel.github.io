...
if (import.meta.env.MODE === 'development') {
  ...
  //themeParams = {'link_color': '#2481cc', 'bg_color': '#ffffff', 'button_color': '#2481cc', 'header_bg_color': '#efeff3', 'button_text_color': '#ffffff', 'section_bg_color': '#ffffff', 'destructive_text_color': '#ff3b30', 'secondary_bg_color': '#efeff3', 'accent_text_color': '#2481cc', 'subtitle_text_color': '#999999', 'section_separator_color': '#eaeaea', 'section_header_text_color': '#6d6d71', 'bottom_bar_bg_color': '#e4e4e4', 'text_color': '#000000', 'hint_color': '#999999'}
} else {
